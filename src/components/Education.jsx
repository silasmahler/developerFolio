                    ...
                    >
                        <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                            ...
                            <div className="flex-grow">
                                ...
                                <h4 className="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-2">{school.subHeader}</h4>
                                <p className="text-gray-600 dark:text-gray-400 mb-4">{school.desc}</p>
                                {school.descBullets && (
